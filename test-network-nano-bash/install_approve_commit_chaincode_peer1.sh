...
# peer lifecycle chaincode package basic.tar.gz --path /Users/ustas-dev/hyperledger_fabric/fabric-samples/asset-transfer-basic/chaincode-typescript/ --lang node --label basic_1
